...
class MathTopicAdmin(admin.ModelAdmin):
    list_display  = ['name', 'level', 'color', 'order', 'description']
    list_editable = ['level', 'color', 'order']
    list_filter   = ['level']
...
class ExamAdmin(admin.ModelAdmin):
    list_display      = ['title', 'exam_type', 'term', 'academic_year', 'exam_date', 'max_score', 'passing_score', 'is_published']
    ...
    fieldsets = (
        (None, {
            'fields': ('title', 'exam_type', 'term', 'academic_year', 'exam_date', 'is_published'),
        }),
        ('Scoring', {
