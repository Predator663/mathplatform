...
urlpatterns = [
    ...
    path('topics/overview/', views.TopicIntelligenceOverviewView.as_view(), name='topic_intelligence_overview'),
    path('topics/<int:topic_id>/distribution/', views.TopicIntelligenceDistributionView.as_view(), name='topic_intelligence_distribution'),
    ...
    path('classrooms/<int:classroom_id>/trends/', views.ClassroomTrendRosterView.as_view(), name='classroom_trends'),
