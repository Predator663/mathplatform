...
if table_exists("site_settings"):
    ...
    with connection.cursor() as c:
        c.execute("INSERT INTO site_settings (id, platform_name, platform_subtitle, logo_url, logo_letter, favicon_url, footer_text, page_settings, login_tagline, login_welcome, login_bg_gradient) VALUES (1, 'MathPlatform', 'Tanzania', '', 'M', '', 'MathPlatform', '{}', 'Perfomance analysis', 'Sign in to your account', TRUE) ON CONFLICT DO NOTHING")
