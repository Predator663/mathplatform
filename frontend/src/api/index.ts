...
export const analyticsApi = {
  ...
  classroomAnalytics: (id: number) => api.get(`/analytics/classrooms/${id}/`),
  classAnalytics: (id: number, params?: object) => api.get(`/analytics/classrooms/${id}/`, { params }),
  studentAnalytics: (id: number) => api.get(`/analytics/students/${id}/summary/`),
  studentSummary: (id: number) => api.get(`/analytics/students/${id}/summary/`),
  studentTrend: (id: number, params?: object) => api.get(`/analytics/students/${id}/trend/`, { params }),
  studentTopics: (id: number) => api.get(`/analytics/students/${id}/topics/`),
