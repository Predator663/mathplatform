...
import GroupAssignmentsPage from './pages/groups/GroupAssignmentsPage';
      ...
      <SyncProvider>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="groups/assignments"    element={<GroupAssignmentsPage />} />
            <Route path="groups/assignments/:id/marks" element={<GroupAssignmentMarksPage />} />
