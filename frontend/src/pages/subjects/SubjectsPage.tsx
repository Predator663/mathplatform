...
export default function SubjectsPage() {
  ...
  // Subjects default to admin-only (see DEFAULT_TEACHER_PERMISSIONS); an
  // admin can opt teachers in from Settings → Site → Teacher Permissions.
  const canAdd = useCanManage('subjects', 'add');
  const canEdit = useCanManage('subjects', 'edit');
