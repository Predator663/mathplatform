...
export default function CreateStudentPage() {
  ...
  return (
    <PermissionGate resource="students" action="add" backTo="/students" backLabel="Back to Students">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        ...
        <div className="card p-6 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            />
            <Input
              label="Index Number (optional)"
              placeholder="e.g. NECTA index"
        ...
        <div className="card p-6 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input label="Parent / Guardian Name" placeholder="Jane Doe" {...register('parent_name')} />
            <Input label="Parent Phone" type="tel" placeholder="+255 7xx xxx xxx" {...register('parent_phone')} />
          </div>
        </div>
        ...
        <div className="card p-6 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input label="Region" placeholder="e.g. Dodoma" {...register('region')} />
            <Input label="District" placeholder="e.g. Dodoma Urban" {...register('district')} />
          </div>
